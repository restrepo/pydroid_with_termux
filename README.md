...
jupyter-lab
```
which would open the JupyterLab interface in the browser, as shown in the image in the [section below](https://github.com/restrepo/pydroid_with_termux/blob/main/README.md#termux)
